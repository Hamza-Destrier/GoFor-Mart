...
const co_grandtotal_el_checkout = document.querySelector(".checkoutTotal");
const checkout_cardDetails = document.querySelector(
  ".checkout-CardItemsDetails"
);
const checkout_subtotalofAllItems = document.querySelector(
  ".subtotalofAllItems"
);
const deliverychargesofAllItems = document.querySelector(".deliverycharges");

const getTotalandItemsinCheckout = () => {
  ...
  checkout_subtotalofAllItems.innerHTML =
    "SubTotal:" + " " + "$" + " " + upto2DecimalPlaces(totalAmount);
  deliverychargesofAllItems.innerHTML =
    "Delivery Charges:" + " " + "$" + " " + shippingCharges;
  co_grandtotal_el_checkout.innerHTML =
    "Total:" +
    " " +
    "$" +
    " " +
    upto2DecimalPlaces(totalAmount + shippingCharges);
};
getTotalandItemsinCheckout();

const renderCartItemsCheckout = () => {
  ...
  Object.entries(cartInfoLocalStorage).map(([prodId, count]) => {
    checkout_cardDetails.innerHTML += getCartDetailItemCheckout(prodId, count);
  });
};
renderCartItemsCheckout();

document.querySelectorAll("#checkoutForm input").forEach((e) => {
  e.value = "";
});

document.getElementById("checkoutbtnid").addEventListener("click", () => {
  let isValid = true;
